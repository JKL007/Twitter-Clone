<?php
    ...
    if ($_GET['action'] == "loginSignup") {
        ...
        if ($_POST['loginActive'] == '0'){
            ...
            if ($row['password'] == md5(md5($row['id']).$_POST['password'])) {
                ...
                $error = "Could not find that username and password combination. Please try again.";
            }
    ...
    if ($_GET['action'] == 'toggleFollow') {
      ...
      if (mysqli_num_rows($result) > 0){
        ...
        mysqli_query($link, "INSERT INTO isFollowing (follwer, isFollowing) VALUES (". mysqli_real_escape_string($link, $_SESSION['id']).", "
    ...
    if ($_GET['action'] == 'postTweet') {
      ...
      if (!$_POST['tweetContent']) {
        ...
        mysqli_query($link, "INSERT INTO tweets (tweet, userid, datetime) VALUES (". mysqli_real_escape_string($link, $_POST['tweetContent']).","
