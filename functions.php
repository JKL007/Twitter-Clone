<?php
    ...
    $link = mysqli_connect("sdb-c.hosting.stackcp.net", "twitter-313731d86a", "!Lpl£]BtB&!|", "twitter-313731d86a");
    ...
    function displayTweetBox() {
        ...
        if ($_SESSION['id'] > 0) {
            ...
            echo '<div id="tweetSuccess" class="alert alert-success col-auto">Your tweet was posted successfully.</div>
                  <div id="tweetFail" class="alert alert-danger col-auto"></div>
                  <div class="form">
                    <div class="col-auto">
                      <textarea class="form-control" id="tweetContent"></textarea> 
                    </div>
                    <div class="col-auto">
                      <button class="btn btn-primary mb-3" id="postTweetButton">Post Tweet</button>
                    </div>
